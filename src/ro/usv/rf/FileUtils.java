...
public class FileUtils 
{
	...
	protected static String[][] readLearningSetFromFile(String fileName) throws USVInputFileCustomException
	{
		...
		//  convert ArrayList<ArrayList<Double>> to String[][] for performance
    ...
    public static double[][] convertToDoubleArray(String[][] learningSet) {
		
		double[][] learningSetArray = new double[learningSet.length][];
		
		for (int n = 0; n < learningSet.length; n++) {
			learningSetArray[n][0] = Double.valueOf(learningSet[n][0]);
			learningSetArray[n][1] = Double.valueOf(learningSet[n][1]);
		}
		return learningSetArray;
	}
